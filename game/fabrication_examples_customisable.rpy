...
label fabrication_code:
    scene black
    pause 0.5
    show text "Fabrications examples"
    with dissolve
    pause
    scene black
    pause 0.5
    show text "You are Charlie, a student at the university"
    pause
    show text "In the third week of your course, you have your first group work"
    pause
    show text "You are very excited since you will be working together with your friends"
    pause
    show alex happy at zoomed_in, slightleft
    show text "Alex..."
    pause
    show alex happy at zoom_norm
    show keri happy at zoomed_in, slightright
    show text "... and Pari"
    pause
    scene bg home2
    with dissolve
...
label fabrication_survey:
    ...
    show text "You are Charlie, a student at the university"
    pause
    show text "During your first semester, you worked on a group project together with your friends..."
    pause
    show alex happy at zoomed_in, slightleft
    show text "Alex..."
    pause
    ...
    pause
    scene black
    show text "In the project, you conducted a survey. Today is the final lab session. At the end of the lab session, you are supposed to hand in your survey report"
    pause
    scene bg home2
    with dissolve
    show keri happy at wideleft, zoom_norm
    ...
    show instructor talk:
        xalign 0.5
    s "Hello class. Welcome to the final lab session. Today, you can go through your results again."
    show instructor mhappy
    s "Please remember that you have to hand in after the lab session"
    show instructor talk
    ...
    s "If you have any questions, please feel free to ask me or Sara"
    show instructor talk
    s "We will collect your report at the end of this lab session"
    show instructor mhappy
    s "We wish you the best of luck!"
